...
public class Main {
    public static void main(String[] args) throws IOException {
        String lines = String.valueOf(Files.readAllLines(Paths.get("C:\\Users\\sevval\\Downloads\\HotelReservationSystem\\HotelManagementSystem\\HotelManagementSystem\\src\\main\\java\\Customer.txt"), StandardCharsets.UTF_8)); //pathFromContentRoot
